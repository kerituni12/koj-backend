...
import { LanguageAvgAggregateInput } from './language-avg-aggregate.input';
import { LanguageSumAggregateInput } from './language-sum-aggregate.input';
...
export class LanguageAggregateArgs {
    ...
    _avg?: LanguageAvgAggregateInput;

    @Field(() => LanguageSumAggregateInput, {nullable:true})
    _sum?: LanguageSumAggregateInput;
