...
/***/ "./apps/submission/src/submission/submission-statistic.controller.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


var _a, _b;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SubmissionStatisticController = void 0;
const tslib_1 = __webpack_require__("tslib");
const common_1 = __webpack_require__("@nestjs/common");
...
const submission_statistic_service_1 = __webpack_require__("./apps/submission/src/submission/submission-statistic.service.ts");
let SubmissionStatisticController = class SubmissionStatisticController {
    constructor(submissionStatisticService) {
        this.submissionStatisticService = submissionStatisticService;
    }
...
], SubmissionStatisticController.prototype, "client", void 0);
(0, tslib_1.__decorate)([
    (0, microservices_1.MessagePattern)(constants_1.SUBMISSION_STATISTIC_FIND_MANY),
    (0, instrumentation_1.Span)(),
    (0, tslib_1.__param)(0, (0, microservices_1.Payload)()),
    (0, tslib_1.__metadata)("design:type", Function),
    (0, tslib_1.__metadata)("design:paramtypes", [Object]),
    (0, tslib_1.__metadata)("design:returntype", Promise)
], SubmissionStatisticController.prototype, "m_findMany", null);
SubmissionStatisticController = (0, tslib_1.__decorate)([
    (0, common_1.UseFilters)(exceptions_1.RpcPrismaExceptionFilter),
    (0, common_1.Controller)(),
    (0, tslib_1.__metadata)("design:paramtypes", [typeof (_b = typeof submission_statistic_service_1.SubmissionStatisticService !== "undefined" && submission_statistic_service_1.SubmissionStatisticService) === "function" ? _b : Object])
], SubmissionStatisticController);
exports.SubmissionStatisticController = SubmissionStatisticController;


/***/ }),

/***/ "./apps/submission/src/submission/submission-statistic.service.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


var _a;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.SubmissionStatisticService = void 0;
const tslib_1 = __webpack_require__("tslib");
const common_1 = __webpack_require__("@nestjs/common");
const nestjs_prisma_1 = __webpack_require__("nestjs-prisma");
let SubmissionStatisticService = class SubmissionStatisticService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    findMany(args, select) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            return this.prisma.submissionStatistic.findMany(Object.assign(Object.assign({}, args), { select }));
        });
    }
};
SubmissionStatisticService = (0, tslib_1.__decorate)([
...
exports.SubmissionStatisticService = SubmissionStatisticService;


/***/ }),

/***/ "./apps/submission/src/submission/submission.controller.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const instrumentation_1 = __webpack_require__("./libs/instrumentation/src/index.ts");
const exceptions_1 = __webpack_require__("./libs/common/exceptions/src/index.ts");
const submission_service_1 = __webpack_require__("./apps/submission/src/submission/submission.service.ts");
let SubmissionController = class SubmissionController {
    ...
    m_create({ data, select }) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            try {
                return yield this.submissionService.create(data, select);
            }
            catch (error) {
                console.log(error);
...
(0, tslib_1.__decorate)([
    ...
    (0, tslib_1.__metadata)("design:type", typeof (_a = typeof microservices_1.ClientProxy !== "undefined" && microservices_1.ClientProxy) === "function" ? _a : Object)
], SubmissionController.prototype, "client", void 0);
(0, tslib_1.__decorate)([
    (0, microservices_1.MessagePattern)(constants_1.SUBMISSION_CREATE),
    ...
    (0, tslib_1.__metadata)("design:paramtypes", [Object]),
    (0, tslib_1.__metadata)("design:returntype", Promise)
], SubmissionController.prototype, "m_create", null);
(0, tslib_1.__decorate)([
    (0, microservices_1.MessagePattern)(constants_1.SUBMISSION_FIND_MANY_BY_USER),
    (0, instrumentation_1.Span)(),
    (0, tslib_1.__param)(0, (0, microservices_1.Payload)()),
    (0, tslib_1.__metadata)("design:type", Function),
    (0, tslib_1.__metadata)("design:paramtypes", [Object]),
    (0, tslib_1.__metadata)("design:returntype", Promise)
], SubmissionController.prototype, "m_findManyByUser", null);
(0, tslib_1.__decorate)([
    (0, microservices_1.MessagePattern)(constants_1.SUBMISSION_FIND_UNIQUE),
    (0, instrumentation_1.Span)(),
    (0, tslib_1.__param)(0, (0, microservices_1.Payload)()),
    (0, tslib_1.__metadata)("design:type", Function),
    (0, tslib_1.__metadata)("design:paramtypes", [Object]),
    (0, tslib_1.__metadata)("design:returntype", Promise)
], SubmissionController.prototype, "m_findUnique", null);
(0, tslib_1.__decorate)([
    (0, microservices_1.MessagePattern)(constants_1.SUBMISSION_DELETE),
    (0, tslib_1.__param)(0, (0, microservices_1.Payload)()),
    (0, tslib_1.__metadata)("design:type", Function),
    (0, tslib_1.__metadata)("design:paramtypes", [Object]),
    (0, tslib_1.__metadata)("design:returntype", void 0)
], SubmissionController.prototype, "m_remove", null);
(0, tslib_1.__decorate)([
    (0, microservices_1.MessagePattern)(constants_1.SUBMISSION_SUBMIT),
    (0, tslib_1.__param)(0, (0, microservices_1.Payload)()),
    (0, tslib_1.__metadata)("design:type", Function),
    (0, tslib_1.__metadata)("design:paramtypes", [Object]),
    (0, tslib_1.__metadata)("design:returntype", void 0)
], SubmissionController.prototype, "m_submit", null);
SubmissionController = (0, tslib_1.__decorate)([
    (0, common_1.UseFilters)(exceptions_1.RpcPrismaExceptionFilter),
    (0, common_1.Controller)(),
    (0, tslib_1.__metadata)("design:paramtypes", [typeof (_b = typeof submission_service_1.SubmissionService !== "undefined" && submission_service_1.SubmissionService) === "function" ? _b : Object])
...
/***/ "./apps/submission/src/submission/submission.module.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const nestjs_prisma_1 = __webpack_require__("nestjs-prisma");
const submission_service_1 = __webpack_require__("./apps/submission/src/submission/submission.service.ts");
const submission_controller_1 = __webpack_require__("./apps/submission/src/submission/submission.controller.ts");
const logger_module_1 = __webpack_require__("./apps/koj/src/logger/logger.module.ts");
const submission_statistic_controller_1 = __webpack_require__("./apps/submission/src/submission/submission-statistic.controller.ts");
const submission_statistic_service_1 = __webpack_require__("./apps/submission/src/submission/submission-statistic.service.ts");
...
AppModule = (0, tslib_1.__decorate)([
    (0, common_1.Module)({
        ...
        controllers: [submission_controller_1.SubmissionController, submission_statistic_controller_1.SubmissionStatisticController],
        providers: [submission_service_1.SubmissionService, submission_statistic_service_1.SubmissionStatisticService]
    })
], AppModule);
...
/***/ "./apps/submission/src/submission/submission.service.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const save_folder_util_1 = (0, tslib_1.__importDefault)(__webpack_require__("./apps/submission/src/utils/save-folder.util.ts"));
const save_testcase_util_1 = (0, tslib_1.__importDefault)(__webpack_require__("./apps/submission/src/utils/save-testcase.util.ts"));
const language_config_1 = __webpack_require__("./apps/submission/src/utils/language.config.ts");
const constants_1 = __webpack_require__("./libs/common/constants/src/index.ts");
...
let SubmissionService = class SubmissionService {
    ...
    create(data, select) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            yield this.saveCode(data, domainId, challengeId);
            return this.prisma.submission.create(Object.assign({ data }, select));
        });
    }
    findManyByUser(args, select) {
        return this.prisma.submission.findMany(Object.assign(Object.assign({}, args), { select }));
    }
    ...
    saveCode(data, domainId, slug) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            try {
                ...
                console.log("🚀 ~ file: submission.service.ts ~ line 135 ~ SubmissionService ~ saveCode ~ error", error);
    ...
    submit(data, context) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const code = language_config_1.languageConfigs[languageId].genSolution((0, utils_1.decodeBase64)(content), functionName);
                ...
                if (type === constants_1.RUN_SUBMIT) {
                    const data = {
                        content,
                        domainId,
                        languageId,
    ...
    saveSubmit(data) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            yield this.prisma.submission.create({ data });
        });
    }
    saveStatistic(data) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            const { result, info, content } = data, baseData = (0, tslib_1.__rest)(data, ["result", "info", "content"]);
            baseData.submitCount = 1;
            yield this.prisma.submissionStatistic.upsert({
                where: {
...
SubmissionService = (0, tslib_1.__decorate)([
    (0, common_1.Injectable)(),
...
/***/ "./apps/submission/src/utils/decode-base64.ts":
...
/***/ "./apps/submission/src/utils/language.config.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const tslib_1 = __webpack_require__("tslib");
const code_gen_1 = __webpack_require__("./libs/code-gen/src/index.ts");
const save_code_util_1 = (0, tslib_1.__importDefault)(__webpack_require__("./apps/submission/src/utils/save-code.util.ts"));
...
/***/ "./apps/submission/src/utils/save-code.util.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const decode_base64_1 = (0, tslib_1.__importDefault)(__webpack_require__("./apps/submission/src/utils/decode-base64.ts"));
...
/***/ "./apps/submission/src/utils/save-folder.util.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
/***/ "./apps/submission/src/utils/save-testcase.util.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const tslib_1 = __webpack_require__("tslib");
const promises_1 = __webpack_require__("fs/promises");
const transform_input_util_1 = __webpack_require__("./apps/submission/src/utils/transform-input.util.ts");
function saveTestcases({ inputSchema, path, testcase, index }) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        console.log('🚀 ~ file: save-testcase.util.ts ~ line 8 ~ saveTestcases ~ testcase', testcase);
...
/***/ "./apps/submission/src/utils/transform-input.util.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const core_1 = __webpack_require__("@nestjs/core");
const microservices_1 = __webpack_require__("@nestjs/microservices");
const submission_module_1 = __webpack_require__("./apps/submission/src/submission/submission.module.ts");
function bootstrap() {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        const app = yield core_1.NestFactory.create(submission_module_1.AppModule);
