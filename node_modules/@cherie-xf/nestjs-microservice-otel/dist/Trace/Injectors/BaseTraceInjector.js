...
const storeContext_model_1 = require("../Interceptors/storeContext.model");
    ...
    wrap(prototype, traceName, attributes = {}) {
        const method = {
            [prototype.name]: function (...args) {
                ...
                const parentCtx = storeContext_model_1.StoreContext?.currentContext?.context;
                return api_1.context.with(api_1.trace.setSpan(api_1.context.active(), currentSpan), () => {
                    const span = tracer.startSpan(traceName, undefined, parentCtx);
                    span.setAttributes(attributes);
                    span.setAttribute('trace-injector-args', args);
                    if (prototype.constructor.name === 'AsyncFunction') {
                        ...
                        try {
                            ...
                            span.setAttribute('trace-injector-result', result);
                            span.end();
                            return result;
                        }
                        catch (error) {
