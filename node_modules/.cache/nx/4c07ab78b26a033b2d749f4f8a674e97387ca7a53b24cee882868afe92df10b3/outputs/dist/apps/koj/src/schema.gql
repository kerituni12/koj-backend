...
input BoolNullableFilter {
  equals: Boolean
  not: NestedBoolNullableFilter_1
}
...
input DateTimeNullableFilter {
  ...
  lt: DateTime
  lte: DateTime
  not: NestedDateTimeNullableFilter_1
  notIn: [DateTime!]
}
...
input GroupWhereInput_1 {
  AND: [GroupWhereInput_1!]
  NOT: [GroupWhereInput_1!]
  OR: [GroupWhereInput_1!]
...
input NestedBoolNullableFilter_1 {
  equals: Boolean
  not: NestedBoolNullableFilter_1
}

input NestedDateTimeFilter_1 {
  equals: DateTime
  gt: DateTime
  gte: DateTime
  in: [DateTime!]
...
input NestedDateTimeNullableFilter_1 {
  equals: DateTime
  gt: DateTime
  gte: DateTime
  in: [DateTime!]
...
input NestedIntNullableFilter_1 {
  equals: Int
  gt: Int
  gte: Int
  in: [Int!]
...
input NestedStringFilter_1 {
  ...
  lt: String
  lte: String
  not: NestedStringFilter_1
  notIn: [String!]
  startsWith: String
}

input NestedStringNullableFilter_1 {
  contains: String
  endsWith: String
  equals: String
  gt: String
  ...
  lt: String
  lte: String
  not: NestedStringNullableFilter_1
  notIn: [String!]
  startsWith: String
}
...
input PolicyWhereInput_1 {
  AND: [PolicyWhereInput_1!]
  NOT: [PolicyWhereInput_1!]
  OR: [PolicyWhereInput_1!]
  action: StringFilter
...
input PostWhereInput_1 {
  AND: [PostWhereInput_1!]
  NOT: [PostWhereInput_1!]
  OR: [PostWhereInput_1!]
...
type Query {
  ...
  groups(cursor: GroupWhereUniqueInput, distinct: [GroupScalarFieldEnum!], orderBy: [GroupOrderByWithRelationInput!], skip: Int, take: Int, where: GroupWhereInput_1): [Group!]!
  policies(cursor: PolicyWhereUniqueInput, distinct: [PolicyScalarFieldEnum!], orderBy: [PolicyOrderByWithRelationInput!], skip: Int, take: Int, where: PolicyWhereInput_1): [Policy!]!
  policy(where: PolicyWhereUniqueInput!): Policy!
  post(where: PostWhereUniqueInput!): Post!
  posts(cursor: PostWhereUniqueInput, distinct: [PostScalarFieldEnum!], orderBy: [PostOrderByWithRelationInput!], skip: Int, take: Int, where: PostWhereInput_1): [Post!]!
  problem(id: Int!): Problem!
  problems: [Problem!]!
  role(where: RoleWhereUniqueInput!): Role!
  roles(cursor: RoleWhereUniqueInput, distinct: [RoleScalarFieldEnum!], orderBy: [RoleOrderByWithRelationInput!], skip: Int, take: Int, where: RoleWhereInput_1): [Role!]!
  users(cursor: UserWhereUniqueInput, distinct: [UserScalarFieldEnum!], orderBy: [UserOrderByWithRelationInput!], skip: Int, take: Int, where: UserWhereInput_1): [User!]!
...
input RoleWhereInput_1 {
  AND: [RoleWhereInput_1!]
  NOT: [RoleWhereInput_1!]
  OR: [RoleWhereInput_1!]
  createdAt: DateTimeFilter
  createdByName: StringNullableFilter
  description: StringNullableFilter
...
input UserWhereInput_1 {
  AND: [UserWhereInput_1!]
  NOT: [UserWhereInput_1!]
  OR: [UserWhereInput_1!]
  createdAt: DateTimeFilter
  createdByName: StringNullableFilter
  email: StringFilter
