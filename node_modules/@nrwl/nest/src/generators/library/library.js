...
function libraryGenerator(tree, rawOptions) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const nodeLibraryTask = yield (0, node_1.libraryGenerator)(tree, (0, lib_2.toNodeLibraryGeneratorOptions)(options));
        ...
        return (0, run_tasks_in_serial_1.runTasksInSerial)(nodeLibraryTask, installDepsTask);
    });
}
